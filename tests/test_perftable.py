...
_format_perftable, _format_cfvc_table, _estimate_perf_from_cache, and
_truncate_name.

The async _build_cfvc_rows tests live in test_perftable_cfvc.py."""
...
from tests.perftable_test_utils import _make_rc
...
class TestEstimatePerfFromCache:
    ...
    def test_exact_rank_match(self):
        ...
        with patch('tle.cogs._graph_perftable.cf_common') as mock_cf:
